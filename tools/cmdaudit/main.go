...
var namespaceRef = map[string]struct {
	...
	"ARRAY":          {Doc: "reference/ARRAY.md", Blurb: "Dynamic arrays: create, get/set, sort, and length."},
	...
	"COLLISION":      {Doc: "reference/COLLISION.md", Blurb: "Stateless geometry tests (2D/3D) and persistent BBox/BSphere handles."},
	...
	"CHAR":           {Doc: "reference/CHARACTER_PHYSICS.md", Blurb: "Kinematic character controller API (`CHAR.*`): move, slope, grounding."},
	...
	"CHARCONTROLLER": {Doc: "reference/CHARACTER_PHYSICS.md", Blurb: "Character controller vs 3D physics (Linux/Jolt)."},
	...
	"CONTROLLER":     {Doc: "reference/CHARACTER_PHYSICS.md", Blurb: "Short aliases for kinematic character controller (`CONTROLLER.*`); prefer `CHARCONTROLLER.*`."},

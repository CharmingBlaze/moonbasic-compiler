...
func (m *Module) Register(r runtime.Registrar) {
	...
	r.Register("LIGHT.GETINTENSITY", "light", m.lightGetIntensity)
	r.Register("LIGHT.GETENERGY", "light", m.lightGetIntensity)
	r.Register("LIGHT.GETSHADOW", "light", m.lightGetShadow)
	r.Register("LIGHT.GETRANGE", "light", m.lightGetRange)
	r.Register("LIGHT.GETINNERCONE", "light", m.lightGetInnerCone)
	r.Register("LIGHT.GETOUTERCONE", "light", m.lightGetOuterCone)

	// Additional aliases for manifest compatibility
	r.Register("LIGHT.COLOR", "light", m.lightGetColor)
	r.Register("LIGHT.DIR", "light", m.lightGetDir)
	r.Register("LIGHT.ENABLED", "light", m.lightIsEnabled)
	r.Register("LIGHT.INTENSITY", "light", m.lightGetIntensity)
	r.Register("LIGHT.MAKEDIRECTIONAL", "light", m.lightCreateDirectional)
	r.Register("LIGHT.MAKEPOINT", "light", m.lightCreatePoint)
	r.Register("LIGHT.MAKESPOT", "light", m.lightCreateSpot)
	r.Register("LIGHT.POS", "light", m.lightGetPos)
	r.Register("LIGHT.RANGE", "light", m.lightGetRange)
	r.Register("LIGHT.SHADOW", "light", m.lightGetShadow)

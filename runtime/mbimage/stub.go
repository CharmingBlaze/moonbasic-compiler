...
var imageStubNames = []string{
	"IMAGE.LOAD", "IMAGE.LOADRAW", "IMAGE.LOADSEQUENCE", "IMAGE.LOADGIF",
	"IMAGE.MAKEBLANK", "IMAGE.MAKE", "IMAGE.CREATE", "IMAGE.MAKECOPY", "IMAGE.COPY", "IMAGE.MAKETEXT",
	...
	"IMAGE.COLORBRIGHTNESS", "IMAGE.COLORREPLACE", "IMAGE.CLEARBACKGROUND", "IMAGE.CLEAR",
	...
	"IMAGE.GETPIXEL", "IMAGE.SETFILTER",
	"CLIPBOARD.GETIMAGE",
}

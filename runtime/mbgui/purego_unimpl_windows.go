...
func registerPuregoUnimplemented(reg runtime.Registrar) {
	names := []string{
		...
		"GUI.TEXTBOX", "GUI.SPINNER", "GUI.VALUEBOX", "GUI.VALUEBOXFLOAT", "GUI.VALUEBOXFLOATTEXT", "GUI.VALUEBOXFLOATTEXT$",
		...
		"GUI.MESSAGEBOX", "GUI.TEXTINPUTBOX", "GUI.TEXTINPUTLAST", "GUI.TEXTINPUTLAST$", "GUI.GRID",
	}

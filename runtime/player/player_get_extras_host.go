...
// registerPlayerKCCAliases wires short Player-centric names (Player.GetX-style) to host KCC getters.
...
// playerGetShapeType reports the KCC collision shape; host KCC is capsule semantics.

...
func (m *Module) Register(r runtime.Registrar) {
	...
	r.Register("CAMERA.CREATE", "camera", stub("CAMERA.CREATE"))
	...
	r.Register("CAMERA.SETMODE", "camera", stub("CAMERA.SETMODE"))
	...
	r.Register("CAMERA.UNPROJECT", "camera", stub("CAMERA.UNPROJECT"))
	r.Register("CAMERA.PICK", "camera", stub("CAMERA.PICK"))
	r.Register("CAMERA.SHAKE", "camera", stub("CAMERA.SHAKE"))
	r.Register("CameraFOV", "camera", stub("CameraFOV"))
	r.Register("CameraShake", "camera", stub("CameraShake"))
	r.Register("CameraLookAt", "camera", stub("CameraLookAt"))
	r.Register("CameraRange", "camera", stub("CameraRange"))
	r.Register("CameraZoom", "camera", stub("CameraZoom"))
	r.Register("CameraProject", "camera", stub("CameraProject"))
	r.Register("CAMERA.LOOKATENTITY", "camera", stub("CAMERA.LOOKATENTITY"))
	r.Register("CAMERA.POINTATENTITY", "camera", stub("CAMERA.POINTATENTITY"))
	r.Register("CameraFogMode", "camera", stub("CameraFogMode"))
	r.Register("CameraFogRange", "camera", stub("CameraFogRange"))
	r.Register("CameraFogColor", "camera", stub("CameraFogColor"))
	...
	r.Register("CAMERA.PROJECT", "camera", stub("CAMERA.PROJECT"))
	r.Register("CAMERA.ISONSCREEN", "camera", stub("CAMERA.ISONSCREEN"))
	r.Register("CAMERA.MOUSERAY", "camera", stub("CAMERA.MOUSERAY"))
	r.Register("WORLD.TOSCREEN", "world", stub("WORLD.TOSCREEN"))
	r.Register("WORLD.TOWORLD", "world", stub("WORLD.TOWORLD"))

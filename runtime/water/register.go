...
func (m *Module) Register(r runtime.Registrar) {
	...
	r.Register("WATER.SETROT", "water", runtime.AdaptLegacy(m.wSetRot))
	r.Register("WATER.GETROT", "water", runtime.AdaptLegacy(m.wGetRot))
	r.Register("WATER.SETSCALE", "water", runtime.AdaptLegacy(m.wSetScale))
	r.Register("WATER.GETSCALE", "water", runtime.AdaptLegacy(m.wGetScale))

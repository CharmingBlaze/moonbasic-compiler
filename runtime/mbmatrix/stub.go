...
func (m *Module) Register(reg runtime.Registrar) {
	...
	names := []string{
		...
		"VEC3.CREATE", "VEC3.MAKE", "VEC3.FREE", "VEC3.X", "VEC3.Y", "VEC3.Z", "VEC3.SET",
		"VEC3.ADD", "VEC3.SUB", "VEC3.MUL", "VEC3.DIV", "VEC3.DOT", "VEC3.CROSS", "VEC3.LENGTH", "VEC3.NORMALIZE",
		"VEC3.LERP", "VEC3.DISTANCE", "VEC3.DIST", "VEC3.DISTSQ", "VEC3.REFLECT", "VEC3.NEGATE", "VEC3.EQUALS",
		"VEC3.VEC3", "VEC3.VECADD", "VEC3.VECSUB", "VEC3.VECSCALE", "VEC3.VECNORMALIZE",
		"VEC3.VECDOT", "VEC3.VECCROSS", "VEC3.VECLENGTH",
		"VEC3.TRANSFORMMAT4", "VEC3.ANGLE", "VEC3.PROJECT", "VEC3.ORTHONORMALIZE", "VEC3.ROTATEBYQUAT",
		"VEC2.CREATE", "VEC2.MAKE", "VEC2.FREE", "VEC2.X", "VEC2.Y", "VEC2.SET",
		...
		"COLOR.LERP", "COLOR.FADE", "COLOR.TOHSV", "COLOR.TOHSVX", "COLOR.TOHSVY", "COLOR.TOHSVZ", "COLOR.TOHEX",

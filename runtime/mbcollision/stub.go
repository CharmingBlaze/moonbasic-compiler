...
func (m *Module) Register(reg runtime.Registrar) {
	...
	names := []string{
		...
		"BBOX.CREATE", "BBOX.MAKE", "BBOX.FROMMODEL", "BBOX.CHECK", "BBOX.CHECKSPHERE", "BBOX.FREE",
		"BSPHERE.CREATE", "BSPHERE.MAKE", "BSPHERE.CHECK", "BSPHERE.CHECKBOX", "BSPHERE.FREE",
	}
	for _, n := range names {

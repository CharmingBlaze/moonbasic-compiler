...
func (m *Module) Register(r runtime.Registrar) {
	...
	for _, k := range []string{
		...
		"TEXTURE.WIDTH", "TEXTURE.HEIGHT", "TEXTURE.GETWIDTH", "TEXTURE.GETHEIGHT", "TEXTURE.GETSIZE", "TEXTUREWIDTH", "TEXTUREHEIGHT", "TEXTURE.SETFILTER", "TEXTURE.SETDEFAULTFILTER", "MATERIAL.AUTOFILTER", "TEXTURE.SETWRAP", "TEXTURE.UPDATE", "TEXTURE.RELOAD",

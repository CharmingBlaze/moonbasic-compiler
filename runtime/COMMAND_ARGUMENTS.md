# MoonBasic Command Arguments Reference

This document provides a comprehensive list of all MoonBasic commands with their exact arguments and expected types.
